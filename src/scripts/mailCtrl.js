...
angular.module('signupManager', [])
.controller('mcCtrl',[ '$http', '$scope', '$window', function( $http, $scope, $window ){
    // $scope.server = 'http://localhost:3005'; // do not include trailing '/'
    ...
    $scope.init = function () {
        ...
        $scope.submitButton = "Send Message";
        $scope.submitSubscribeButton = "Send";
        console.log('ran signup init and button is', $scope.submitSubscribeButton);
...
angular.bootstrap(document.getElementById("mc-signup-app"), ['signupManager']);
